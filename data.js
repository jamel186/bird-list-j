...
const BIRDS = [
  ...
  },
  {
    ...
    location: "Prince William Forest Park, VA, USA",
    habitat: ["forest"],
    notes: "Very common during the first two weeks of May in Virginia. Its rising song ending with a sharp drop is heard in all kinds of forest habitat during this time. Tiny and fast, hard to photograph as it forages in the canopy",
    photos: [{ file: "parula.JPG", caption: "Female coming down for a quick bath in a stream" }],
    videoUrl: ""
  },
   {
  ...
  },
  {
    ...
    photos: [{ file: "daurian.JPG", caption: "Female or juvenile sitting in a small tree in the mountains" }],
    videoUrl: ""
  },
   {
  ...
  },
  {
    ...
    location: "Backyard, VA, USA",
    habitat: ["urban", "scrub"],
    notes: "A very common bird in bushy areas in both urban neighborhoods and parks. Differentiated from the Mockingbird with its song that repeats phrases only once. Also makes catlike noises. A couple pairs nest in my neighborhood. A cute looking bird and the harbinger of Spring",
    photos: [{file: "catbird.JPG", caption: "Singing on a low branch"}],
    videoUrl: ""
  },
  
   {
    ...
    photos: [{file: "blueJay.JPG", caption: "A spark of bright blue in the drab winter woods"}],
    videoUrl: ""
  },
  {
    ...
    photos: [{file: "mourningDove.JPG", caption: "A pair doing their courtship ritual before copulating on our porch"}],
    videoUrl: ""
  },
  {
  ...
  },
  {
    ...
    photos: [{file:"blueHeaded.JPG", caption: "Feeding in a mixed species flock, blue head and white spectacles are clearly visible"}],
    videoUrl: ""
  },
    {
