...
const LOCATIONS = [
  {
    ...
    photos: [{ file:"huntleyMarsh.JPG", caption:"The view from the boardwalk" },
            { file:"huntleyForest.JPG", caption:"The forest that the trail cuts through" },
            { file:"huntleyWater.JPG", caption:"The section with open water" },
            { file:"huntleyMudflat.JPG", caption:"Sometimes in the late summer, the open water section turns into mudflats. Here you can see egrets in the distance" }],
  ...
  },
  {
    ...
    region: "Alexandria, VA, USA",
    photos: [{ file:"huntleyPath.JPG", caption:"The very straight path in May" },
            { file:"huntleyMeadow.JPG", caption:"The meadow early in the spring" },
            { file:"huntleyObs.JPG", caption:"The view from one of the observation decks" }],
